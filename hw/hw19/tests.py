...
def test_average_edge():
    ...
    assert(average_edge({"p1":2, "p2":4, "p3":4, "p4":6}, {"p1":1, "p2":1, "p3":1, "p4":5}) == round(3.3684210526315788, round_factor))
    assert(average_edge({"p1":1, "p2":2, "p3":3, "p4":4, "p5":5},
                        {"p1":1, "p2":2, "p3":3, "p4":4, "p5":5}) == round(1.560068324160182, round_factor))
...
def test_predict_state_edges():
    ...
    round(-2.0908256880733944, round_factor), 'FL': 0.5, 'ID': round(-0.6788990825688075, round_factor), 
    'WA': round(-10.799509886766941, round_factor)})
